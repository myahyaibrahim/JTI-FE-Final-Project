...
const DashboardExample = () => {
  ...
  useEffect(() => {
    axios
      .get(api + "/monitor", { withCredentials: true })
                          ...
                          {data.map((monitoring, index) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                  {monitoring.valveStatus === true
                                    ? "Open"
                                    : "Closed"}
                                </td>
                                <td>
                                  {monitoring.waterUsage} /{" "}
                                  {monitoring.waterLimit}
                                </td>
