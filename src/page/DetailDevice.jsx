                ...
                <div className="row">
                  <div className="col-lg-4 col-md-5 xs-margin-30px-bottom ">
                    <div className="team-single-img">
                      <img
                        src="https://tankdoctor.com.au/wp-content/uploads/2021/10/Filtatank-Twin-filter-system-with-UV-clear-Housings-600x600.jpg"
                        alt=""
                        class="img-thumbnail"
                      />
                      <button className={status.type}>{status.message}</button>
                      {/* {propsData.totalColiforms === 0 &&
                        6.5 <= propsData.ph <= 8.5 &&
                        propsData.turbidity <= 5 &&
                        10 <= propsData.temperature <= 25 &&
                      ...
                      {100 < (propsData.totalColiforms < 1000) ||
                        ...
                        propsData.electricalConductivity <= 200 ||
                        propsData.metal >= 0.3 || (
                          <button className="btn btn-danger btn-sm">Bad</button>
                        )} */}
                    </div>
                  </div>
                    ...
                    <div className="team-single-text padding-50px-left sm-no-padding-left">
                      ...
                      <div className="sm-no-margin">
                        <div className="progress-text">
                          <div className="row">
                            <div className="col-7">
                              Water Usage/ Water Limit
                            </div>
                            <div className="col-5 text-right">
                              {propsData.waterUsage} / {propsData.waterLimit}
                            </div>
                          </div>
                        </div>
                        <div className="progress progress-md">
                          <div
                            ...
                            style={{ width: propsData.waterUsage }}
                          />
                        </div>
                        {/* <div className="progress-text">
                                            <div className="row">
                        ...
                        <div className="progress progress-md">
                          <div
                            className="progress-bar progress-bar-danger"
                            style={{ width: propsData.waterUsageTimer }}
                          />
                        </div>
                      </div>
                    </div>
